...
pid=1;tid=1;batch=1;rcmdbatch=1;trialStartDate="2014-10-01";propInTrial=0.2;avHaz="";indivRRSeed=7;HazTrajSeed=7;numClus=10;clusSize=40;nsims=2;trial="RCT";gs="TRUE";ord="none";contVaccDelay=NA;maxRRcat=0;vaccEff="NA";DoIndivRRcat="TRUE";randVaccProperties="TRUE";delayUnit=7;immunoDelay=21;returnEventTimes="TRUE";vaccPropStrg="vaccProp1";StatsFxns="doCoxME";batchdirnm="BigResults/Equip-Fig5-10clus-3cat";constRiskXClusSize="TRUE";nboot=200;reordLag=14;saveNm="Equip-Fig5-10clus-3cat";simNumStart=1;simNumEnd=2
}
