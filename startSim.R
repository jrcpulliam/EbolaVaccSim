...
seed=1;trial="RCT";ord="TU";propInTrial=0.1;sdLogIndiv=1;delayUnit=7;immunoDelay=21;vaccEff=0.7;remStartFin="TRUE";remProtDel="TRUE";simNum=2880;batchdirnm="BigResults/gsRCT1";saveNm="gsRCT";nsims=1;reordLag=14;nboot=20;trialStartDate="2015-02-18"; gs=T;randVaccProperties=F;vaccPropStrg=NA;simNumStart=(seed-1)*nsims+1;simNumEnd=(seed-1)*nsims+nsims;returnEventTimes=T
}
...
simArgs <- list(seed=seed, parms=parms, N=nsims, verbFreq=10, vaccProp=vaccProp, returnEventTimes=returnEventTimes,
