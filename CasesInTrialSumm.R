...
thing <- 'CasesInTrialLID_Correspondence'
...
powFin <- summarise(group_by(finTrials, vaccEff, trial, propInTrial, ord, delayUnit, mod, immunoDelay,trialStartDate
                    ...
                    , caseTot_Active = mean(caseCXimmGrpEnd_Active + caseVXimmGrpEnd_Active )
                    , caseC_Active = mean(caseCXimmGrpEnd_Active)
                    , caseV_Active = mean(caseVXimmGrpEnd_Active)
